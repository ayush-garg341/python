...
def main():
    ...
    print("'K' closest numbers to 'X' are: " + str(find_closest_elements([0, 0, 1, 2, 3, 3, 4, 7, 7, 8], 3, 5)))

    print(" ======================= ")

    print("'K' closest numbers to 'X' are: " + str(find_closest_elements_two_pointers([5, 6, 7, 8, 9], 3, 7)))
    print("'K' closest numbers to 'X' are: " + str(find_closest_elements_two_pointers([2, 4, 5, 6, 9], 3, 6)))
    print("'K' closest numbers to 'X' are: " + str(find_closest_elements_two_pointers([2, 4, 5, 6, 9], 3, 10)))
    print(
