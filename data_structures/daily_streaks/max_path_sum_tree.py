...
class Solution:
    ...
    def maxPathSumRec(self, root):
        ...
        max_through_root = max(left_subtree_max_sum + root.val, right_subtree_max_sum + root.val)
        total_sum = max(total_sum, left_subtree_max_sum + right_subtree_max_sum + root.val)
