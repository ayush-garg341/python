...
def find_subsets_efficient(nums):
    subsets = []
    end_index = 0
    subsets.append([])
    nums.sort()
...
def main():
    ...
    print(" ========================= ")
    print("Here is the list of subsets: " + str(find_subsets_efficient([1, 3, 3])))
    print("Here is the list of subsets: " + str(find_subsets_efficient([1, 5, 3, 3])))
    print("Here is the list of subsets: " + str(find_subsets_efficient([1, 1])))
    print("Here is the list of subsets: " + str(find_subsets_efficient([1, 2, 2])))
