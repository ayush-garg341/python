...
)  # True, which poses a bit of a problem since it violates the definition of an interface!
...
print(
    "Employee is a subclass of PersonSuper = {} since inheriting from it".format(
        issubclass(Employee, PersonSuper)
    )
)
print(
    "Person Super is a subclass of Person = {} since it implements all methods of Person".format(
        issubclass(PersonSuper, Person)
    )
)
print(issubclass(Employee, Person))
print(
    "Friend is not inheriting from PersonSuper and no relation of meta class as well and hence = {}".format(
        issubclass(Friend, PersonSuper)
    )
)
print(
    "Person is acting as virtual base class for friend and hence = {}".format(
        issubclass(Friend, Person)
    )
)

print("Friend is an instance of Person = {}".format(isinstance(Friend, Person)))
print(
    "Employee is an instance of PersonSuper = {}".format(
        isinstance(Employee, PersonSuper)
    )
)
...
print(
    "----------------------------- using subclasshook and registering tha class -------------------------------"
)
